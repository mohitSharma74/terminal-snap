...
describe('export', () => {
  ...
  beforeEach(() => {
    ...
    mockElement.innerHTML = '<div data-scrollable="true" style="max-height: 300px; overflow: auto;">Content</div>'
  ...
  describe('exportAsPNG', () => {
    ...
    it('should temporarily remove maxHeight from scrollable elements', async () => {
      const scrollableEl = mockElement.querySelector('[data-scrollable="true"]') as HTMLElement
